...
class BasinScanner:
    ...
    def run_scan(self):
        ...
        # After you've filled `grid`, `m_range`, `l_range`:
        np.save("delta_fate_grid.npy", grid)
        np.save("delta_fate_m_range.npy", m_range)
        np.save("delta_fate_l_range.npy", l_range)
        logger.info("Saved raw grid and axis arrays for post-processing.")
