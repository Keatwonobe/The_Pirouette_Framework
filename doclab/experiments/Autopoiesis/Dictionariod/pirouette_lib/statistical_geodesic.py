"""
Auto-generated from dictionary entry: STATISTICAL_GEODESIC
...
Auto-generated at 2025-10-19T01:26:51.376049Z
"""
...
class StatisticalGeodesic(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="STATISTICAL_GEODESIC:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"STATISTICAL_GEODESIC:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="STATISTICAL_GEODESIC:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"STATISTICAL_GEODESIC:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.statistical_geodesic import StatisticalGeodesic\n>>> # TODO: fill example"
