"""
Auto-generated from dictionary entry: TIME_FIRST_QED_LIMIT
...
Auto-generated at 2025-10-19T01:26:51.501040Z
"""
...
class TimeFirstQedLimit(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TIME_FIRST_QED_LIMIT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TIME_FIRST_QED_LIMIT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TIME_FIRST_QED_LIMIT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TIME_FIRST_QED_LIMIT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.time_first_qed_limit import TimeFirstQedLimit\n>>> # TODO: fill example"
