"""
Auto-generated from dictionary entry: HADRONIC_INSULATION
...
Auto-generated at 2025-10-19T01:26:50.823680Z
"""
...
class HadronicInsulation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HADRONIC_INSULATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HADRONIC_INSULATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HADRONIC_INSULATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.hadronic_insulation import HadronicInsulation\n>>> # TODO: fill example"
