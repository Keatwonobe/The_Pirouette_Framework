"""
Auto-generated from dictionary entry: PORTAL_TOPOLOGY_INDICES
...
Auto-generated at 2025-10-19T01:26:51.130307Z
"""
...
class PortalTopologyIndices(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PORTAL_TOPOLOGY_INDICES:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PORTAL_TOPOLOGY_INDICES:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PORTAL_TOPOLOGY_INDICES:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PORTAL_TOPOLOGY_INDICES:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.portal_topology_indices import PortalTopologyIndices\n>>> # TODO: fill example"
