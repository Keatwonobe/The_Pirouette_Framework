"""
Auto-generated from dictionary entry: CONSTANT_SURFACE_DENSITY_LOCUS
...
Auto-generated at 2025-10-19T01:26:50.557483Z
"""
...
class ConstantSurfaceDensityLocus(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CONSTANT_SURFACE_DENSITY_LOCUS:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CONSTANT_SURFACE_DENSITY_LOCUS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CONSTANT_SURFACE_DENSITY_LOCUS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CONSTANT_SURFACE_DENSITY_LOCUS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.constant_surface_density_locus import ConstantSurfaceDensityLocus\n>>> # TODO: fill example"
