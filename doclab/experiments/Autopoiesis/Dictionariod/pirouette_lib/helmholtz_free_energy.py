"""
Auto-generated from dictionary entry: HELMHOLTZ_FREE_ENERGY
...
Auto-generated at 2025-10-19T01:26:50.841680Z
"""
...
class HelmholtzFreeEnergy(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="HELMHOLTZ_FREE_ENERGY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HELMHOLTZ_FREE_ENERGY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HELMHOLTZ_FREE_ENERGY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HELMHOLTZ_FREE_ENERGY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.helmholtz_free_energy import HelmholtzFreeEnergy\n>>> # TODO: fill example"
