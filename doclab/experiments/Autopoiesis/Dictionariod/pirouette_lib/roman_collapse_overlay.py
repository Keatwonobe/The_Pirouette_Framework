"""
Auto-generated from dictionary entry: ROMAN_COLLAPSE_OVERLAY
...
Auto-generated at 2025-10-19T01:26:51.292050Z
"""
...
class RomanCollapseOverlay(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ROMAN_COLLAPSE_OVERLAY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ROMAN_COLLAPSE_OVERLAY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ROMAN_COLLAPSE_OVERLAY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ROMAN_COLLAPSE_OVERLAY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.roman_collapse_overlay import RomanCollapseOverlay\n>>> # TODO: fill example"
