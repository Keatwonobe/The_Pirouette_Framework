"""
Auto-generated from dictionary entry: PULSAR_TIMING_ARRAY
...
Auto-generated at 2025-10-19T01:26:51.174307Z
"""
...
class PulsarTimingArray(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PULSAR_TIMING_ARRAY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PULSAR_TIMING_ARRAY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PULSAR_TIMING_ARRAY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.pulsar_timing_array import PulsarTimingArray\n>>> # TODO: fill example"
