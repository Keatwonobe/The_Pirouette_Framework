"""
Auto-generated from dictionary entry: RARE_DILEPTON_BRANCHING
...
Auto-generated at 2025-10-19T01:26:51.190306Z
"""
...
class RareDileptonBranching(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RARE_DILEPTON_BRANCHING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RARE_DILEPTON_BRANCHING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RARE_DILEPTON_BRANCHING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RARE_DILEPTON_BRANCHING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.rare_dilepton_branching import RareDileptonBranching\n>>> # TODO: fill example"
