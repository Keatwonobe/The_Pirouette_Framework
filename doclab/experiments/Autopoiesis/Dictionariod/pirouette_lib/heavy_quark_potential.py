"""
Auto-generated from dictionary entry: HEAVY_QUARK_POTENTIAL
...
Auto-generated at 2025-10-19T01:26:50.840680Z
"""
...
class HeavyQuarkPotential(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="HEAVY_QUARK_POTENTIAL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HEAVY_QUARK_POTENTIAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HEAVY_QUARK_POTENTIAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HEAVY_QUARK_POTENTIAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.heavy_quark_potential import HeavyQuarkPotential\n>>> # TODO: fill example"
