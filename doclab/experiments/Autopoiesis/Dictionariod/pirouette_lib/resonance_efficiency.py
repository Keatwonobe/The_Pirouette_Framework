"""
Auto-generated from dictionary entry: RESONANCE_EFFICIENCY
...
Auto-generated at 2025-10-19T01:26:51.221461Z
"""
...
class ResonanceEfficiency(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RESONANCE_EFFICIENCY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RESONANCE_EFFICIENCY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RESONANCE_EFFICIENCY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RESONANCE_EFFICIENCY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.resonance_efficiency import ResonanceEfficiency\n>>> # TODO: fill example"
