"""
Auto-generated from dictionary entry: SUBSTRATE_DEVIATION_SCALE
...
Auto-generated at 2025-10-19T01:26:51.396040Z
"""
...
class SubstrateDeviationScale(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SUBSTRATE_DEVIATION_SCALE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SUBSTRATE_DEVIATION_SCALE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SUBSTRATE_DEVIATION_SCALE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SUBSTRATE_DEVIATION_SCALE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.substrate_deviation_scale import SubstrateDeviationScale\n>>> # TODO: fill example"
