"""
Auto-generated from dictionary entry: HEURISTIC_DISTILLATION
...
Auto-generated at 2025-10-19T01:26:50.843680Z
"""
...
class HeuristicDistillation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="HEURISTIC_DISTILLATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HEURISTIC_DISTILLATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HEURISTIC_DISTILLATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HEURISTIC_DISTILLATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.heuristic_distillation import HeuristicDistillation\n>>> # TODO: fill example"
