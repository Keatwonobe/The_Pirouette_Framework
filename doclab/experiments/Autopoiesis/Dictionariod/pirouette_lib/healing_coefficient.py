"""
Auto-generated from dictionary entry: HEALING_COEFFICIENT
...
Auto-generated at 2025-10-19T01:26:50.837681Z
"""
...
class HealingCoefficient(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HEALING_COEFFICIENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HEALING_COEFFICIENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HEALING_COEFFICIENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.healing_coefficient import HealingCoefficient\n>>> # TODO: fill example"
