"""
Auto-generated from dictionary entry: ARCHAEOLOGIST_S_SIEVE
...
Auto-generated at 2025-10-19T01:26:50.297004Z
"""
...
class ArchaeologistSSieve(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ARCHAEOLOGIST_S_SIEVE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ARCHAEOLOGIST_S_SIEVE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ARCHAEOLOGIST_S_SIEVE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ARCHAEOLOGIST_S_SIEVE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.archaeologist_s_sieve import ArchaeologistSSieve\n>>> # TODO: fill example"
