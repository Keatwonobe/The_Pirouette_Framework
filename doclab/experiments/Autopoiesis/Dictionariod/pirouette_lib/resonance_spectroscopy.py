"""
Auto-generated from dictionary entry: RESONANCE_SPECTROSCOPY
...
Auto-generated at 2025-10-19T01:26:51.225461Z
"""
...
class ResonanceSpectroscopy(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RESONANCE_SPECTROSCOPY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RESONANCE_SPECTROSCOPY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RESONANCE_SPECTROSCOPY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RESONANCE_SPECTROSCOPY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.resonance_spectroscopy import ResonanceSpectroscopy\n>>> # TODO: fill example"
