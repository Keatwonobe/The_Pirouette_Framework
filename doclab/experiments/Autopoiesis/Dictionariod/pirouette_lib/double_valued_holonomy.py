"""
Auto-generated from dictionary entry: DOUBLE_VALUED_HOLONOMY
...
Auto-generated at 2025-10-19T01:26:50.655680Z
"""
...
class DoubleValuedHolonomy(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DOUBLE_VALUED_HOLONOMY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DOUBLE_VALUED_HOLONOMY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DOUBLE_VALUED_HOLONOMY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DOUBLE_VALUED_HOLONOMY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.double_valued_holonomy import DoubleValuedHolonomy\n>>> # TODO: fill example"
