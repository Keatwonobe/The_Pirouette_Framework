"""
Auto-generated from dictionary entry: MAGNETIC_MOMENT_CORRECTION
...
Auto-generated at 2025-10-19T01:26:50.990306Z
"""
...
class MagneticMomentCorrection(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MAGNETIC_MOMENT_CORRECTION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MAGNETIC_MOMENT_CORRECTION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MAGNETIC_MOMENT_CORRECTION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MAGNETIC_MOMENT_CORRECTION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.magnetic_moment_correction import MagneticMomentCorrection\n>>> # TODO: fill example"
