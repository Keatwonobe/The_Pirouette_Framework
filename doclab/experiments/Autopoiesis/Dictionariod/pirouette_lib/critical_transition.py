"""
Auto-generated from dictionary entry: CRITICAL_TRANSITION
...
Auto-generated at 2025-10-19T01:26:50.594681Z
"""
...
class CriticalTransition(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CRITICAL_TRANSITION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CRITICAL_TRANSITION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CRITICAL_TRANSITION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.critical_transition import CriticalTransition\n>>> # TODO: fill example"
