"""
Auto-generated from dictionary entry: WORLDLINE_FORMALISM
...
Auto-generated at 2025-10-19T01:26:51.602039Z
"""
...
class WorldlineFormalism(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"WORLDLINE_FORMALISM:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="WORLDLINE_FORMALISM:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"WORLDLINE_FORMALISM:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.worldline_formalism import WorldlineFormalism\n>>> # TODO: fill example"
