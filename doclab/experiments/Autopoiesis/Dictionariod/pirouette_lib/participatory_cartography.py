"""
Auto-generated from dictionary entry: PARTICIPATORY_CARTOGRAPHY
...
Auto-generated at 2025-10-19T01:26:51.076307Z
"""
...
class ParticipatoryCartography(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PARTICIPATORY_CARTOGRAPHY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PARTICIPATORY_CARTOGRAPHY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PARTICIPATORY_CARTOGRAPHY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PARTICIPATORY_CARTOGRAPHY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.participatory_cartography import ParticipatoryCartography\n>>> # TODO: fill example"
