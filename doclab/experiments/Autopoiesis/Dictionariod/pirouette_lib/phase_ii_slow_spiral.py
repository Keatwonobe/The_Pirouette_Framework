"""
Auto-generated from dictionary entry: PHASE_II_SLOW_SPIRAL
...
Auto-generated at 2025-10-19T01:26:51.094306Z
"""
...
class PhaseIiSlowSpiral(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PHASE_II_SLOW_SPIRAL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PHASE_II_SLOW_SPIRAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PHASE_II_SLOW_SPIRAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PHASE_II_SLOW_SPIRAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.phase_ii_slow_spiral import PhaseIiSlowSpiral\n>>> # TODO: fill example"
