"""
Auto-generated from dictionary entry: DUAL_NON_PERTURBATIVE_TRACK
...
Auto-generated at 2025-10-19T01:26:50.656680Z
"""
...
class DualNonPerturbativeTrack(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DUAL_NON_PERTURBATIVE_TRACK:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DUAL_NON_PERTURBATIVE_TRACK:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DUAL_NON_PERTURBATIVE_TRACK:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DUAL_NON_PERTURBATIVE_TRACK:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.dual_non_perturbative_track import DualNonPerturbativeTrack\n>>> # TODO: fill example"
