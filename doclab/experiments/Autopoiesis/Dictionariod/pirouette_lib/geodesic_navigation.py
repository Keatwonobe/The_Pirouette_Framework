"""
Auto-generated from dictionary entry: GEODESIC_NAVIGATION
...
Auto-generated at 2025-10-19T01:26:50.784681Z
"""
...
class GeodesicNavigation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"GEODESIC_NAVIGATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="GEODESIC_NAVIGATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"GEODESIC_NAVIGATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.geodesic_navigation import GeodesicNavigation\n>>> # TODO: fill example"
