"""
Auto-generated from dictionary entry: CLOCK_SYNCHRONIZATION_CHARGE_UNIT
...
Auto-generated at 2025-10-19T01:26:50.397003Z
"""
...
class ClockSynchronizationChargeUnit(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CLOCK_SYNCHRONIZATION_CHARGE_UNIT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CLOCK_SYNCHRONIZATION_CHARGE_UNIT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CLOCK_SYNCHRONIZATION_CHARGE_UNIT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CLOCK_SYNCHRONIZATION_CHARGE_UNIT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.clock_synchronization_charge_unit import ClockSynchronizationChargeUnit\n>>> # TODO: fill example"
