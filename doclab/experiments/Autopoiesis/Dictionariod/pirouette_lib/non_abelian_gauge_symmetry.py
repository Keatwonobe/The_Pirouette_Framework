"""
Auto-generated from dictionary entry: NON_ABELIAN_GAUGE_SYMMETRY
...
Auto-generated at 2025-10-19T01:26:51.044307Z
"""
...
class NonAbelianGaugeSymmetry(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="NON_ABELIAN_GAUGE_SYMMETRY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"NON_ABELIAN_GAUGE_SYMMETRY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="NON_ABELIAN_GAUGE_SYMMETRY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"NON_ABELIAN_GAUGE_SYMMETRY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.non_abelian_gauge_symmetry import NonAbelianGaugeSymmetry\n>>> # TODO: fill example"
