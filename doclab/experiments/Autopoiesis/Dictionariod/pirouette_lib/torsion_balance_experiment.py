"""
Auto-generated from dictionary entry: TORSION_BALANCE_EXPERIMENT
...
Auto-generated at 2025-10-19T01:26:51.514039Z
"""
...
class TorsionBalanceExperiment(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TORSION_BALANCE_EXPERIMENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TORSION_BALANCE_EXPERIMENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TORSION_BALANCE_EXPERIMENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TORSION_BALANCE_EXPERIMENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.torsion_balance_experiment import TorsionBalanceExperiment\n>>> # TODO: fill example"
