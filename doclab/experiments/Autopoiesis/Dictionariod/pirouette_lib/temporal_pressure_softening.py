"""
Auto-generated from dictionary entry: TEMPORAL_PRESSURE_SOFTENING
...
Auto-generated at 2025-10-19T01:26:51.444040Z
"""
...
class TemporalPressureSoftening(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TEMPORAL_PRESSURE_SOFTENING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TEMPORAL_PRESSURE_SOFTENING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TEMPORAL_PRESSURE_SOFTENING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TEMPORAL_PRESSURE_SOFTENING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.temporal_pressure_softening import TemporalPressureSoftening\n>>> # TODO: fill example"
