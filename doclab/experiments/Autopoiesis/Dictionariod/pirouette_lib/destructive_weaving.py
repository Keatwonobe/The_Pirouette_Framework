"""
Auto-generated from dictionary entry: DESTRUCTIVE_WEAVING
...
Auto-generated at 2025-10-19T01:26:50.632681Z
"""
...
class DestructiveWeaving(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DESTRUCTIVE_WEAVING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DESTRUCTIVE_WEAVING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DESTRUCTIVE_WEAVING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.destructive_weaving import DestructiveWeaving\n>>> # TODO: fill example"
