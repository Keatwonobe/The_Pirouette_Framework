"""
Auto-generated from dictionary entry: MASS_SCALING_EXPONENT
...
Auto-generated at 2025-10-19T01:26:51.006307Z
"""
...
class MassScalingExponent(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MASS_SCALING_EXPONENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MASS_SCALING_EXPONENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MASS_SCALING_EXPONENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MASS_SCALING_EXPONENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.mass_scaling_exponent import MassScalingExponent\n>>> # TODO: fill example"
