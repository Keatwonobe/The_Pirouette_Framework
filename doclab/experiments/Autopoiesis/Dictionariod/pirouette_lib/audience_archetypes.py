"""
Auto-generated from dictionary entry: AUDIENCE_ARCHETYPES
...
Auto-generated at 2025-10-19T01:26:50.312003Z
"""
...
class AudienceArchetypes(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"AUDIENCE_ARCHETYPES:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="AUDIENCE_ARCHETYPES:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"AUDIENCE_ARCHETYPES:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.audience_archetypes import AudienceArchetypes\n>>> # TODO: fill example"
