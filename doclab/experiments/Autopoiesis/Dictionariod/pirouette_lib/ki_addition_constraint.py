"""
Auto-generated from dictionary entry: KI_ADDITION_CONSTRAINT
...
Auto-generated at 2025-10-19T01:26:50.912308Z
"""
...
class KiAdditionConstraint(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="KI_ADDITION_CONSTRAINT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"KI_ADDITION_CONSTRAINT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="KI_ADDITION_CONSTRAINT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"KI_ADDITION_CONSTRAINT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.ki_addition_constraint import KiAdditionConstraint\n>>> # TODO: fill example"
