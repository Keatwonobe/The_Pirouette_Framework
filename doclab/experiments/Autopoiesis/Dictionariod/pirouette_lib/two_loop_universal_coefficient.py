"""
Auto-generated from dictionary entry: TWO_LOOP_UNIVERSAL_COEFFICIENT
...
Auto-generated at 2025-10-19T01:26:51.551040Z
"""
...
class TwoLoopUniversalCoefficient(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TWO_LOOP_UNIVERSAL_COEFFICIENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TWO_LOOP_UNIVERSAL_COEFFICIENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TWO_LOOP_UNIVERSAL_COEFFICIENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TWO_LOOP_UNIVERSAL_COEFFICIENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.two_loop_universal_coefficient import TwoLoopUniversalCoefficient\n>>> # TODO: fill example"
