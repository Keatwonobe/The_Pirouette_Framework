"""
Auto-generated from dictionary entry: THE_FOUR_PHASES_OF_RECOVERY
...
Auto-generated at 2025-10-19T01:26:51.469039Z
"""
...
class TheFourPhasesOfRecovery(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="THE_FOUR_PHASES_OF_RECOVERY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"THE_FOUR_PHASES_OF_RECOVERY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="THE_FOUR_PHASES_OF_RECOVERY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"THE_FOUR_PHASES_OF_RECOVERY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.the_four_phases_of_recovery import TheFourPhasesOfRecovery\n>>> # TODO: fill example"
