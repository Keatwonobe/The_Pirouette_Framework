"""
Auto-generated from dictionary entry: NO_ESCAPE_CONDITION
...
Auto-generated at 2025-10-19T01:26:51.039307Z
"""
...
class NoEscapeCondition(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"NO_ESCAPE_CONDITION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="NO_ESCAPE_CONDITION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"NO_ESCAPE_CONDITION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.no_escape_condition import NoEscapeCondition\n>>> # TODO: fill example"
