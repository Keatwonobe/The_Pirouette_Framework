"""
Auto-generated from dictionary entry: RESONANCE_MATCHED_SHOCK
...
Auto-generated at 2025-10-19T01:26:51.224460Z
"""
...
class ResonanceMatchedShock(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RESONANCE_MATCHED_SHOCK:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RESONANCE_MATCHED_SHOCK:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RESONANCE_MATCHED_SHOCK:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RESONANCE_MATCHED_SHOCK:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.resonance_matched_shock import ResonanceMatchedShock\n>>> # TODO: fill example"
