"""
Auto-generated from dictionary entry: MACROPARTICLE_LATTICE
...
Auto-generated at 2025-10-19T01:26:50.987307Z
"""
...
class MacroparticleLattice(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MACROPARTICLE_LATTICE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MACROPARTICLE_LATTICE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MACROPARTICLE_LATTICE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MACROPARTICLE_LATTICE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.macroparticle_lattice import MacroparticleLattice\n>>> # TODO: fill example"
