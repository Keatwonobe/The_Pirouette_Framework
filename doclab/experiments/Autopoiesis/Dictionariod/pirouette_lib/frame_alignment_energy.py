"""
Auto-generated from dictionary entry: FRAME_ALIGNMENT_ENERGY
...
Auto-generated at 2025-10-19T01:26:50.748680Z
"""
...
class FrameAlignmentEnergy(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="FRAME_ALIGNMENT_ENERGY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"FRAME_ALIGNMENT_ENERGY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="FRAME_ALIGNMENT_ENERGY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"FRAME_ALIGNMENT_ENERGY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.frame_alignment_energy import FrameAlignmentEnergy\n>>> # TODO: fill example"
