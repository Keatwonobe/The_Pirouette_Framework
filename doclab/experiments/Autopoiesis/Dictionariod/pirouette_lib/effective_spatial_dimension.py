"""
Auto-generated from dictionary entry: EFFECTIVE_SPATIAL_DIMENSION
...
Auto-generated at 2025-10-19T01:26:50.675681Z
"""
...
class EffectiveSpatialDimension(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="EFFECTIVE_SPATIAL_DIMENSION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"EFFECTIVE_SPATIAL_DIMENSION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="EFFECTIVE_SPATIAL_DIMENSION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"EFFECTIVE_SPATIAL_DIMENSION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.effective_spatial_dimension import EffectiveSpatialDimension\n>>> # TODO: fill example"
