"""
Auto-generated from dictionary entry: ELECTROMAGNETIC_STIFFNESS
...
Auto-generated at 2025-10-19T01:26:50.682680Z
"""
...
class ElectromagneticStiffness(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ELECTROMAGNETIC_STIFFNESS:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ELECTROMAGNETIC_STIFFNESS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ELECTROMAGNETIC_STIFFNESS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ELECTROMAGNETIC_STIFFNESS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.electromagnetic_stiffness import ElectromagneticStiffness\n>>> # TODO: fill example"
