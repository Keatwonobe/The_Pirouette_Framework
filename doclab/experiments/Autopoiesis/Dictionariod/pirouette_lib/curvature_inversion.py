"""
Auto-generated from dictionary entry: CURVATURE_INVERSION
...
Auto-generated at 2025-10-19T01:26:50.618680Z
"""
...
class CurvatureInversion(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CURVATURE_INVERSION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CURVATURE_INVERSION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CURVATURE_INVERSION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.curvature_inversion import CurvatureInversion\n>>> # TODO: fill example"
