"""
Auto-generated from dictionary entry: CERTIFICATE_OF_TRANSLATION
...
Auto-generated at 2025-10-19T01:26:50.376003Z
"""
...
class CertificateOfTranslation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CERTIFICATE_OF_TRANSLATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CERTIFICATE_OF_TRANSLATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CERTIFICATE_OF_TRANSLATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CERTIFICATE_OF_TRANSLATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.certificate_of_translation import CertificateOfTranslation\n>>> # TODO: fill example"
