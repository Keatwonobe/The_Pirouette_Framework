"""
Auto-generated from dictionary entry: MEASUREMENT_STRENGTH
...
Auto-generated at 2025-10-19T01:26:51.015307Z
"""
...
class MeasurementStrength(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MEASUREMENT_STRENGTH:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MEASUREMENT_STRENGTH:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MEASUREMENT_STRENGTH:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MEASUREMENT_STRENGTH:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.measurement_strength import MeasurementStrength\n>>> # TODO: fill example"
