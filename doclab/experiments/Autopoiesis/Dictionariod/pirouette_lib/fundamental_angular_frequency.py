"""
Auto-generated from dictionary entry: FUNDAMENTAL_ANGULAR_FREQUENCY
...
Auto-generated at 2025-10-19T01:26:50.757680Z
"""
...
class FundamentalAngularFrequency(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="FUNDAMENTAL_ANGULAR_FREQUENCY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"FUNDAMENTAL_ANGULAR_FREQUENCY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="FUNDAMENTAL_ANGULAR_FREQUENCY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"FUNDAMENTAL_ANGULAR_FREQUENCY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.fundamental_angular_frequency import FundamentalAngularFrequency\n>>> # TODO: fill example"
