"""
Auto-generated from dictionary entry: LOCAL_KNOT_OF_COHERENCE
...
Auto-generated at 2025-10-19T01:26:50.976308Z
"""
...
class LocalKnotOfCoherence(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="LOCAL_KNOT_OF_COHERENCE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"LOCAL_KNOT_OF_COHERENCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="LOCAL_KNOT_OF_COHERENCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"LOCAL_KNOT_OF_COHERENCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.local_knot_of_coherence import LocalKnotOfCoherence\n>>> # TODO: fill example"
