"""
Auto-generated from dictionary entry: TOPOLOGICAL_IRREDUCIBILITY
...
Auto-generated at 2025-10-19T01:26:51.511040Z
"""
...
class TopologicalIrreducibility(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TOPOLOGICAL_IRREDUCIBILITY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TOPOLOGICAL_IRREDUCIBILITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TOPOLOGICAL_IRREDUCIBILITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TOPOLOGICAL_IRREDUCIBILITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.topological_irreducibility import TopologicalIrreducibility\n>>> # TODO: fill example"
