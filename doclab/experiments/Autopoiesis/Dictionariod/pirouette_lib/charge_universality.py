"""
Auto-generated from dictionary entry: CHARGE_UNIVERSALITY
...
Auto-generated at 2025-10-19T01:26:50.382003Z
"""
...
class ChargeUniversality(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CHARGE_UNIVERSALITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CHARGE_UNIVERSALITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CHARGE_UNIVERSALITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.charge_universality import ChargeUniversality\n>>> # TODO: fill example"
