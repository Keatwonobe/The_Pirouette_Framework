"""
Auto-generated from dictionary entry: FLUCTUATION_OPERATOR
...
Auto-generated at 2025-10-19T01:26:50.736681Z
"""
...
class FluctuationOperator(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="FLUCTUATION_OPERATOR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"FLUCTUATION_OPERATOR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="FLUCTUATION_OPERATOR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"FLUCTUATION_OPERATOR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.fluctuation_operator import FluctuationOperator\n>>> # TODO: fill example"
