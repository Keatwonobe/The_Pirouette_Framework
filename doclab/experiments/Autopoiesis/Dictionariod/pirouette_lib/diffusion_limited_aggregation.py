"""
Auto-generated from dictionary entry: DIFFUSION_LIMITED_AGGREGATION
...
Auto-generated at 2025-10-19T01:26:50.637681Z
"""
...
class DiffusionLimitedAggregation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DIFFUSION_LIMITED_AGGREGATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DIFFUSION_LIMITED_AGGREGATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DIFFUSION_LIMITED_AGGREGATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DIFFUSION_LIMITED_AGGREGATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.diffusion_limited_aggregation import DiffusionLimitedAggregation\n>>> # TODO: fill example"
