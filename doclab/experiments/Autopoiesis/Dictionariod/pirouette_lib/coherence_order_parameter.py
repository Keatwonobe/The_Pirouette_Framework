"""
Auto-generated from dictionary entry: COHERENCE_ORDER_PARAMETER
...
Auto-generated at 2025-10-19T01:26:50.482484Z
"""
...
class CoherenceOrderParameter(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COHERENCE_ORDER_PARAMETER:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COHERENCE_ORDER_PARAMETER:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COHERENCE_ORDER_PARAMETER:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COHERENCE_ORDER_PARAMETER:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.coherence_order_parameter import CoherenceOrderParameter\n>>> # TODO: fill example"
