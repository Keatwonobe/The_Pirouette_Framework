"""
Auto-generated from dictionary entry: SPECTRAL_DENSITY_OF_NOISE
...
Auto-generated at 2025-10-19T01:26:51.359050Z
"""
...
class SpectralDensityOfNoise(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SPECTRAL_DENSITY_OF_NOISE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SPECTRAL_DENSITY_OF_NOISE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SPECTRAL_DENSITY_OF_NOISE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SPECTRAL_DENSITY_OF_NOISE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.spectral_density_of_noise import SpectralDensityOfNoise\n>>> # TODO: fill example"
