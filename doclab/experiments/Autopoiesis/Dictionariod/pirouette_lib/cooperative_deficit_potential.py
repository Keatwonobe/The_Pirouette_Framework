"""
Auto-generated from dictionary entry: COOPERATIVE_DEFICIT_POTENTIAL
...
Auto-generated at 2025-10-19T01:26:50.565483Z
"""
...
class CooperativeDeficitPotential(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COOPERATIVE_DEFICIT_POTENTIAL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COOPERATIVE_DEFICIT_POTENTIAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COOPERATIVE_DEFICIT_POTENTIAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COOPERATIVE_DEFICIT_POTENTIAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.cooperative_deficit_potential import CooperativeDeficitPotential\n>>> # TODO: fill example"
