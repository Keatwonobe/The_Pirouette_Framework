"""
Auto-generated from dictionary entry: TAIL_COHERENCE_FRACTION
...
Auto-generated at 2025-10-19T01:26:51.419039Z
"""
...
class TailCoherenceFraction(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TAIL_COHERENCE_FRACTION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TAIL_COHERENCE_FRACTION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TAIL_COHERENCE_FRACTION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TAIL_COHERENCE_FRACTION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.tail_coherence_fraction import TailCoherenceFraction\n>>> # TODO: fill example"
