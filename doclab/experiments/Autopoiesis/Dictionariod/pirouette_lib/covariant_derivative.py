"""
Auto-generated from dictionary entry: COVARIANT_DERIVATIVE
...
Auto-generated at 2025-10-19T01:26:50.583681Z
"""
...
class CovariantDerivative(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COVARIANT_DERIVATIVE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COVARIANT_DERIVATIVE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COVARIANT_DERIVATIVE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COVARIANT_DERIVATIVE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.covariant_derivative import CovariantDerivative\n>>> # TODO: fill example"
