"""
Auto-generated from dictionary entry: STATIC_LOVE_NUMBERS
...
Auto-generated at 2025-10-19T01:26:51.374050Z
"""
...
class StaticLoveNumbers(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"STATIC_LOVE_NUMBERS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="STATIC_LOVE_NUMBERS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"STATIC_LOVE_NUMBERS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.static_love_numbers import StaticLoveNumbers\n>>> # TODO: fill example"
