"""
Auto-generated from dictionary entry: SELF_COUPLING_CONSTANT
...
Auto-generated at 2025-10-19T01:26:51.313049Z
"""
...
class SelfCouplingConstant(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SELF_COUPLING_CONSTANT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SELF_COUPLING_CONSTANT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SELF_COUPLING_CONSTANT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SELF_COUPLING_CONSTANT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.self_coupling_constant import SelfCouplingConstant\n>>> # TODO: fill example"
