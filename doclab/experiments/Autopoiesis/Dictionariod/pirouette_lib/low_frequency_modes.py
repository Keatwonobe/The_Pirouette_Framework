"""
Auto-generated from dictionary entry: LOW_FREQUENCY_MODES
...
Auto-generated at 2025-10-19T01:26:50.983307Z
"""
...
class LowFrequencyModes(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"LOW_FREQUENCY_MODES:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="LOW_FREQUENCY_MODES:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"LOW_FREQUENCY_MODES:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.low_frequency_modes import LowFrequencyModes\n>>> # TODO: fill example"
