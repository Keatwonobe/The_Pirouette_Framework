"""
Auto-generated from dictionary entry: GAUGE_COVARIANT_TIME_DERIVATIVE
...
Auto-generated at 2025-10-19T01:26:50.767681Z
"""
...
class GaugeCovariantTimeDerivative(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="GAUGE_COVARIANT_TIME_DERIVATIVE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"GAUGE_COVARIANT_TIME_DERIVATIVE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="GAUGE_COVARIANT_TIME_DERIVATIVE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"GAUGE_COVARIANT_TIME_DERIVATIVE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.gauge_covariant_time_derivative import GaugeCovariantTimeDerivative\n>>> # TODO: fill example"
