"""
Auto-generated from dictionary entry: CORRESPONDENCE_GAUGE
...
Auto-generated at 2025-10-19T01:26:50.570483Z
"""
...
class CorrespondenceGauge(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CORRESPONDENCE_GAUGE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CORRESPONDENCE_GAUGE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CORRESPONDENCE_GAUGE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CORRESPONDENCE_GAUGE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.correspondence_gauge import CorrespondenceGauge\n>>> # TODO: fill example"
