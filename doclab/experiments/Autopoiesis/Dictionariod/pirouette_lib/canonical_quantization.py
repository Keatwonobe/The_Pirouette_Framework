"""
Auto-generated from dictionary entry: CANONICAL_QUANTIZATION
...
Auto-generated at 2025-10-19T01:26:50.366003Z
"""
...
class CanonicalQuantization(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CANONICAL_QUANTIZATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CANONICAL_QUANTIZATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CANONICAL_QUANTIZATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CANONICAL_QUANTIZATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.canonical_quantization import CanonicalQuantization\n>>> # TODO: fill example"
