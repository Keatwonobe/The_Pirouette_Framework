"""
Auto-generated from dictionary entry: COMPOSURE_UNDER_PRESSURE
...
Auto-generated at 2025-10-19T01:26:50.541484Z
"""
...
class ComposureUnderPressure(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COMPOSURE_UNDER_PRESSURE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COMPOSURE_UNDER_PRESSURE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COMPOSURE_UNDER_PRESSURE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COMPOSURE_UNDER_PRESSURE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.composure_under_pressure import ComposureUnderPressure\n>>> # TODO: fill example"
