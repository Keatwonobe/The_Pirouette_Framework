"""
Auto-generated from dictionary entry: SELF_ENERGY_CORRECTION
...
Auto-generated at 2025-10-19T01:26:51.315050Z
"""
...
class SelfEnergyCorrection(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SELF_ENERGY_CORRECTION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SELF_ENERGY_CORRECTION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SELF_ENERGY_CORRECTION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SELF_ENERGY_CORRECTION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.self_energy_correction import SelfEnergyCorrection\n>>> # TODO: fill example"
