"""
Auto-generated from dictionary entry: RECOVERY_EFFICIENCY
...
Auto-generated at 2025-10-19T01:26:51.196449Z
"""
...
class RecoveryEfficiency(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RECOVERY_EFFICIENCY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RECOVERY_EFFICIENCY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RECOVERY_EFFICIENCY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.recovery_efficiency import RecoveryEfficiency\n>>> # TODO: fill example"
