"""
Auto-generated from dictionary entry: COMPOSITE_SUPERFLUID
...
Auto-generated at 2025-10-19T01:26:50.539483Z
"""
...
class CompositeSuperfluid(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COMPOSITE_SUPERFLUID:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COMPOSITE_SUPERFLUID:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COMPOSITE_SUPERFLUID:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COMPOSITE_SUPERFLUID:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.composite_superfluid import CompositeSuperfluid\n>>> # TODO: fill example"
