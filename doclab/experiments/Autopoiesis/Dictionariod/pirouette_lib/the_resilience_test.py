"""
Auto-generated from dictionary entry: THE_RESILIENCE_TEST
...
Auto-generated at 2025-10-19T01:26:51.482039Z
"""
...
class TheResilienceTest(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"THE_RESILIENCE_TEST:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="THE_RESILIENCE_TEST:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"THE_RESILIENCE_TEST:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.the_resilience_test import TheResilienceTest\n>>> # TODO: fill example"
