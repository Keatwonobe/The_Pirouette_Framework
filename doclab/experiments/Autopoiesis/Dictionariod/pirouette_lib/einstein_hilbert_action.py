"""
Auto-generated from dictionary entry: EINSTEIN_HILBERT_ACTION
...
Auto-generated at 2025-10-19T01:26:50.677680Z
"""
...
class EinsteinHilbertAction(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="EINSTEIN_HILBERT_ACTION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"EINSTEIN_HILBERT_ACTION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="EINSTEIN_HILBERT_ACTION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"EINSTEIN_HILBERT_ACTION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.einstein_hilbert_action import EinsteinHilbertAction\n>>> # TODO: fill example"
