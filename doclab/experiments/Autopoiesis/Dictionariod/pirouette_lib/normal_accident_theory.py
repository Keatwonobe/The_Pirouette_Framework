"""
Auto-generated from dictionary entry: NORMAL_ACCIDENT_THEORY
...
Auto-generated at 2025-10-19T01:26:51.048307Z
"""
...
class NormalAccidentTheory(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="NORMAL_ACCIDENT_THEORY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"NORMAL_ACCIDENT_THEORY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="NORMAL_ACCIDENT_THEORY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"NORMAL_ACCIDENT_THEORY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.normal_accident_theory import NormalAccidentTheory\n>>> # TODO: fill example"
