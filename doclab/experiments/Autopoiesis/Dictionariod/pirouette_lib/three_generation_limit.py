"""
Auto-generated from dictionary entry: THREE_GENERATION_LIMIT
...
Auto-generated at 2025-10-19T01:26:51.495040Z
"""
...
class ThreeGenerationLimit(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="THREE_GENERATION_LIMIT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"THREE_GENERATION_LIMIT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="THREE_GENERATION_LIMIT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"THREE_GENERATION_LIMIT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.three_generation_limit import ThreeGenerationLimit\n>>> # TODO: fill example"
