"""
Auto-generated from dictionary entry: HADRONIC_INSULATION_RATIO
...
Auto-generated at 2025-10-19T01:26:50.824680Z
"""
...
class HadronicInsulationRatio(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="HADRONIC_INSULATION_RATIO:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HADRONIC_INSULATION_RATIO:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HADRONIC_INSULATION_RATIO:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HADRONIC_INSULATION_RATIO:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.hadronic_insulation_ratio import HadronicInsulationRatio\n>>> # TODO: fill example"
