"""
Auto-generated from dictionary entry: TIME_FIRST_SUBSTRATE
...
Auto-generated at 2025-10-19T01:26:51.502040Z
"""
...
class TimeFirstSubstrate(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TIME_FIRST_SUBSTRATE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TIME_FIRST_SUBSTRATE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TIME_FIRST_SUBSTRATE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TIME_FIRST_SUBSTRATE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.time_first_substrate import TimeFirstSubstrate\n>>> # TODO: fill example"
