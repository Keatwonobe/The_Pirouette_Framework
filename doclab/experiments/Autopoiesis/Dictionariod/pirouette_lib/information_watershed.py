"""
Auto-generated from dictionary entry: INFORMATION_WATERSHED
...
Auto-generated at 2025-10-19T01:26:50.869680Z
"""
...
class InformationWatershed(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="INFORMATION_WATERSHED:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"INFORMATION_WATERSHED:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="INFORMATION_WATERSHED:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"INFORMATION_WATERSHED:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.information_watershed import InformationWatershed\n>>> # TODO: fill example"
