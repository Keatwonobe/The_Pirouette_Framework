"""
Auto-generated from dictionary entry: STRESS_ENERGY_TENSOR
...
Auto-generated at 2025-10-19T01:26:51.385049Z
"""
...
class StressEnergyTensor(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="STRESS_ENERGY_TENSOR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"STRESS_ENERGY_TENSOR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="STRESS_ENERGY_TENSOR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"STRESS_ENERGY_TENSOR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.stress_energy_tensor import StressEnergyTensor\n>>> # TODO: fill example"
