"""
Auto-generated from dictionary entry: DIMENSIONAL_UNFOLDING
...
Auto-generated at 2025-10-19T01:26:50.638680Z
"""
...
class DimensionalUnfolding(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DIMENSIONAL_UNFOLDING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DIMENSIONAL_UNFOLDING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DIMENSIONAL_UNFOLDING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DIMENSIONAL_UNFOLDING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.dimensional_unfolding import DimensionalUnfolding\n>>> # TODO: fill example"
