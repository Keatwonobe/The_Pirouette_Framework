"""
Auto-generated from dictionary entry: WEAK_WHICH_WAY_MEASUREMENT
...
class WeakWhichWayMeasurement(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="WEAK_WHICH_WAY_MEASUREMENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"WEAK_WHICH_WAY_MEASUREMENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="WEAK_WHICH_WAY_MEASUREMENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"WEAK_WHICH_WAY_MEASUREMENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.weak_which_way_measurement import WeakWhichWayMeasurement\n>>> # TODO: fill example"
