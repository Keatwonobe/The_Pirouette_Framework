"""
Auto-generated from dictionary entry: BACKGROUND_FIELD_METHOD
...
Auto-generated at 2025-10-19T01:26:50.329003Z
"""
...
class BackgroundFieldMethod(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="BACKGROUND_FIELD_METHOD:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"BACKGROUND_FIELD_METHOD:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="BACKGROUND_FIELD_METHOD:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"BACKGROUND_FIELD_METHOD:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.background_field_method import BackgroundFieldMethod\n>>> # TODO: fill example"
