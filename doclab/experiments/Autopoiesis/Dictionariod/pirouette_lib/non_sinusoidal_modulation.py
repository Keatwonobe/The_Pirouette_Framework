"""
Auto-generated from dictionary entry: NON_SINUSOIDAL_MODULATION
...
Auto-generated at 2025-10-19T01:26:51.047306Z
"""
...
class NonSinusoidalModulation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="NON_SINUSOIDAL_MODULATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"NON_SINUSOIDAL_MODULATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="NON_SINUSOIDAL_MODULATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"NON_SINUSOIDAL_MODULATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.non_sinusoidal_modulation import NonSinusoidalModulation\n>>> # TODO: fill example"
