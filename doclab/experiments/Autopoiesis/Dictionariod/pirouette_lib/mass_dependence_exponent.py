"""
Auto-generated from dictionary entry: MASS_DEPENDENCE_EXPONENT
...
Auto-generated at 2025-10-19T01:26:51.001307Z
"""
...
class MassDependenceExponent(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MASS_DEPENDENCE_EXPONENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MASS_DEPENDENCE_EXPONENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MASS_DEPENDENCE_EXPONENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MASS_DEPENDENCE_EXPONENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.mass_dependence_exponent import MassDependenceExponent\n>>> # TODO: fill example"
