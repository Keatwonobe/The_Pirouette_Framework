"""
Auto-generated from dictionary entry: ORDEAL_OF_COHERENCE
...
Auto-generated at 2025-10-19T01:26:51.063307Z
"""
...
class OrdealOfCoherence(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ORDEAL_OF_COHERENCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ORDEAL_OF_COHERENCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ORDEAL_OF_COHERENCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.ordeal_of_coherence import OrdealOfCoherence\n>>> # TODO: fill example"
