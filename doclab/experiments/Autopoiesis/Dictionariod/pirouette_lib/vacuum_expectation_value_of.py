"""
Auto-generated from dictionary entry: VACUUM_EXPECTATION_VALUE_OF
...
Auto-generated at 2025-10-19T01:26:51.566040Z
"""
...
class VacuumExpectationValueOf(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="VACUUM_EXPECTATION_VALUE_OF:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"VACUUM_EXPECTATION_VALUE_OF:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="VACUUM_EXPECTATION_VALUE_OF:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"VACUUM_EXPECTATION_VALUE_OF:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.vacuum_expectation_value_of import VacuumExpectationValueOf\n>>> # TODO: fill example"
