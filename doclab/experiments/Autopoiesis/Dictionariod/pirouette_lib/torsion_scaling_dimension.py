"""
Auto-generated from dictionary entry: TORSION_SCALING_DIMENSION
...
Auto-generated at 2025-10-19T01:26:51.516039Z
"""
...
class TorsionScalingDimension(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TORSION_SCALING_DIMENSION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TORSION_SCALING_DIMENSION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TORSION_SCALING_DIMENSION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TORSION_SCALING_DIMENSION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.torsion_scaling_dimension import TorsionScalingDimension\n>>> # TODO: fill example"
