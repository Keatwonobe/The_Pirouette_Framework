"""
Auto-generated from dictionary entry: TRIAD_PHASE_COHERENCE_INDEX_TPCI
...
Auto-generated at 2025-10-19T01:26:51.523040Z
"""
...
class TriadPhaseCoherenceIndexTpci(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TRIAD_PHASE_COHERENCE_INDEX_TPCI:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TRIAD_PHASE_COHERENCE_INDEX_TPCI:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TRIAD_PHASE_COHERENCE_INDEX_TPCI:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TRIAD_PHASE_COHERENCE_INDEX_TPCI:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.triad_phase_coherence_index_tpci import TriadPhaseCoherenceIndexTpci\n>>> # TODO: fill example"
