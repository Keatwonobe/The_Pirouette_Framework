"""
Auto-generated from dictionary entry: GEOMETRIC_RECURSION
...
Auto-generated at 2025-10-19T01:26:50.798738Z
"""
...
class GeometricRecursion(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"GEOMETRIC_RECURSION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="GEOMETRIC_RECURSION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"GEOMETRIC_RECURSION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.geometric_recursion import GeometricRecursion\n>>> # TODO: fill example"
