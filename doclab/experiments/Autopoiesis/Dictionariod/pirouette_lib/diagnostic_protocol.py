"""
Auto-generated from dictionary entry: DIAGNOSTIC_PROTOCOL
...
Auto-generated at 2025-10-19T01:26:50.636681Z
"""
...
class DiagnosticProtocol(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DIAGNOSTIC_PROTOCOL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DIAGNOSTIC_PROTOCOL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DIAGNOSTIC_PROTOCOL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.diagnostic_protocol import DiagnosticProtocol\n>>> # TODO: fill example"
