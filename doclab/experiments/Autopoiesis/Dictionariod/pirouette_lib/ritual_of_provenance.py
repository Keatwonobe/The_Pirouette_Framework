"""
Auto-generated from dictionary entry: RITUAL_OF_PROVENANCE
...
Auto-generated at 2025-10-19T01:26:51.291050Z
"""
...
class RitualOfProvenance(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RITUAL_OF_PROVENANCE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RITUAL_OF_PROVENANCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RITUAL_OF_PROVENANCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RITUAL_OF_PROVENANCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.ritual_of_provenance import RitualOfProvenance\n>>> # TODO: fill example"
