"""
Auto-generated from dictionary entry: DOUBLE_FUNNEL_GEOMETRY
...
Auto-generated at 2025-10-19T01:26:50.654680Z
"""
...
class DoubleFunnelGeometry(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DOUBLE_FUNNEL_GEOMETRY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DOUBLE_FUNNEL_GEOMETRY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DOUBLE_FUNNEL_GEOMETRY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DOUBLE_FUNNEL_GEOMETRY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.double_funnel_geometry import DoubleFunnelGeometry\n>>> # TODO: fill example"
