"""
Auto-generated from dictionary entry: SHADOW_GAUGE_PROTOCOL
...
Auto-generated at 2025-10-19T01:26:51.328050Z
"""
...
class ShadowGaugeProtocol(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SHADOW_GAUGE_PROTOCOL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SHADOW_GAUGE_PROTOCOL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SHADOW_GAUGE_PROTOCOL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SHADOW_GAUGE_PROTOCOL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.shadow_gauge_protocol import ShadowGaugeProtocol\n>>> # TODO: fill example"
