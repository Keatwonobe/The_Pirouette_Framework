"""
Auto-generated from dictionary entry: VORTICYCLE_PROPULSION
...
Auto-generated at 2025-10-19T01:26:51.579039Z
"""
...
class VorticyclePropulsion(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="VORTICYCLE_PROPULSION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"VORTICYCLE_PROPULSION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="VORTICYCLE_PROPULSION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"VORTICYCLE_PROPULSION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.vorticycle_propulsion import VorticyclePropulsion\n>>> # TODO: fill example"
