"""
Auto-generated from dictionary entry: GLOBALLY_HYPERBOLIC_SPACETIME
...
class GloballyHyperbolicSpacetime(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="GLOBALLY_HYPERBOLIC_SPACETIME:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"GLOBALLY_HYPERBOLIC_SPACETIME:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="GLOBALLY_HYPERBOLIC_SPACETIME:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"GLOBALLY_HYPERBOLIC_SPACETIME:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.globally_hyperbolic_spacetime import GloballyHyperbolicSpacetime\n>>> # TODO: fill example"
