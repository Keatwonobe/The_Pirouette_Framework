"""
Auto-generated from dictionary entry: ON_SHELL_RENORMALIZATION
...
Auto-generated at 2025-10-19T01:26:51.059307Z
"""
...
class OnShellRenormalization(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ON_SHELL_RENORMALIZATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ON_SHELL_RENORMALIZATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ON_SHELL_RENORMALIZATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ON_SHELL_RENORMALIZATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.on_shell_renormalization import OnShellRenormalization\n>>> # TODO: fill example"
