"""
Auto-generated from dictionary entry: CLASSICAL_STABILITY
...
Auto-generated at 2025-10-19T01:26:50.392003Z
"""
...
class ClassicalStability(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CLASSICAL_STABILITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CLASSICAL_STABILITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CLASSICAL_STABILITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.classical_stability import ClassicalStability\n>>> # TODO: fill example"
