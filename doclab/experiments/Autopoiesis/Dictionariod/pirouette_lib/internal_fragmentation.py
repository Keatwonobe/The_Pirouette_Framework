"""
Auto-generated from dictionary entry: INTERNAL_FRAGMENTATION
...
Auto-generated at 2025-10-19T01:26:50.887681Z
"""
...
class InternalFragmentation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="INTERNAL_FRAGMENTATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"INTERNAL_FRAGMENTATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="INTERNAL_FRAGMENTATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"INTERNAL_FRAGMENTATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.internal_fragmentation import InternalFragmentation\n>>> # TODO: fill example"
