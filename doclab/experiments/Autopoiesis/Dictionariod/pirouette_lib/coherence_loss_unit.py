"""
Auto-generated from dictionary entry: COHERENCE_LOSS_UNIT
...
Auto-generated at 2025-10-19T01:26:50.474484Z
"""
...
class CoherenceLossUnit(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COHERENCE_LOSS_UNIT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COHERENCE_LOSS_UNIT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COHERENCE_LOSS_UNIT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.coherence_loss_unit import CoherenceLossUnit\n>>> # TODO: fill example"
