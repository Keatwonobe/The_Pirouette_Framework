"""
Auto-generated from dictionary entry: STOCHASTIC_HARVESTING
...
Auto-generated at 2025-10-19T01:26:51.382050Z
"""
...
class StochasticHarvesting(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="STOCHASTIC_HARVESTING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"STOCHASTIC_HARVESTING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="STOCHASTIC_HARVESTING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"STOCHASTIC_HARVESTING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.stochastic_harvesting import StochasticHarvesting\n>>> # TODO: fill example"
