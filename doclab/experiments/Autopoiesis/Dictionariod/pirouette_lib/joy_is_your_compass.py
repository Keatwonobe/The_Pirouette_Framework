"""
Auto-generated from dictionary entry: JOY_IS_YOUR_COMPASS
...
Auto-generated at 2025-10-19T01:26:50.905681Z
"""
...
class JoyIsYourCompass(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"JOY_IS_YOUR_COMPASS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="JOY_IS_YOUR_COMPASS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"JOY_IS_YOUR_COMPASS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.joy_is_your_compass import JoyIsYourCompass\n>>> # TODO: fill example"
