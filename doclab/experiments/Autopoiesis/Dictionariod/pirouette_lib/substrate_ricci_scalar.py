"""
Auto-generated from dictionary entry: SUBSTRATE_RICCI_SCALAR
Term: SUBSTRATE_RICCI_SCALAR
Symbol: 
Aliases: 
...
Auto-generated at 2025-10-19T01:26:51.399040Z
"""
...
class SubstrateRicciScalar(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SUBSTRATE_RICCI_SCALAR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SUBSTRATE_RICCI_SCALAR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SUBSTRATE_RICCI_SCALAR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SUBSTRATE_RICCI_SCALAR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.substrate_ricci_scalar import SubstrateRicciScalar\n>>> # TODO: fill example"
