"""
Auto-generated from dictionary entry: PHASE_LOCKING_VALUE
...
Auto-generated at 2025-10-19T01:26:51.100307Z
"""
...
class PhaseLockingValue(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PHASE_LOCKING_VALUE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PHASE_LOCKING_VALUE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PHASE_LOCKING_VALUE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.phase_locking_value import PhaseLockingValue\n>>> # TODO: fill example"
