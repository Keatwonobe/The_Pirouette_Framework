"""
Auto-generated from dictionary entry: TOPOLOGICAL_SOLITON
...
Auto-generated at 2025-10-19T01:26:51.512040Z
"""
...
class TopologicalSoliton(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TOPOLOGICAL_SOLITON:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TOPOLOGICAL_SOLITON:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TOPOLOGICAL_SOLITON:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.topological_soliton import TopologicalSoliton\n>>> # TODO: fill example"
