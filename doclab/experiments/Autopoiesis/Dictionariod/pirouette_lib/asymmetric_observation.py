"""
Auto-generated from dictionary entry: ASYMMETRIC_OBSERVATION
...
Auto-generated at 2025-10-19T01:26:50.304003Z
"""
...
class AsymmetricObservation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ASYMMETRIC_OBSERVATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ASYMMETRIC_OBSERVATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ASYMMETRIC_OBSERVATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ASYMMETRIC_OBSERVATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.asymmetric_observation import AsymmetricObservation\n>>> # TODO: fill example"
