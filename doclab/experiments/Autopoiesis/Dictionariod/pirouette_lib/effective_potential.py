"""
Auto-generated from dictionary entry: EFFECTIVE_POTENTIAL
...
Auto-generated at 2025-10-19T01:26:50.673680Z
"""
...
class EffectivePotential(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"EFFECTIVE_POTENTIAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="EFFECTIVE_POTENTIAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"EFFECTIVE_POTENTIAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.effective_potential import EffectivePotential\n>>> # TODO: fill example"
