"""
Auto-generated from dictionary entry: SCALE_DEPENDENT_SOUND_SPEED
...
Auto-generated at 2025-10-19T01:26:51.301049Z
"""
...
class ScaleDependentSoundSpeed(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SCALE_DEPENDENT_SOUND_SPEED:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SCALE_DEPENDENT_SOUND_SPEED:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SCALE_DEPENDENT_SOUND_SPEED:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SCALE_DEPENDENT_SOUND_SPEED:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.scale_dependent_sound_speed import ScaleDependentSoundSpeed\n>>> # TODO: fill example"
