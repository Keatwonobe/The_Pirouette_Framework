"""
Auto-generated from dictionary entry: STATIONARY_FIELD_BALANCE
...
Auto-generated at 2025-10-19T01:26:51.375050Z
"""
...
class StationaryFieldBalance(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="STATIONARY_FIELD_BALANCE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"STATIONARY_FIELD_BALANCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="STATIONARY_FIELD_BALANCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"STATIONARY_FIELD_BALANCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.stationary_field_balance import StationaryFieldBalance\n>>> # TODO: fill example"
