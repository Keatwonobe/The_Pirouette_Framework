"""
Auto-generated from dictionary entry: QUADRATIC_COEFFICIENT
...
Auto-generated at 2025-10-19T01:26:51.180307Z
"""
...
class QuadraticCoefficient(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="QUADRATIC_COEFFICIENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"QUADRATIC_COEFFICIENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="QUADRATIC_COEFFICIENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"QUADRATIC_COEFFICIENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.quadratic_coefficient import QuadraticCoefficient\n>>> # TODO: fill example"
