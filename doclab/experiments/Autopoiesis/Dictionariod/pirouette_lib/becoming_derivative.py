"""
Auto-generated from dictionary entry: BECOMING_DERIVATIVE
...
Auto-generated at 2025-10-19T01:26:50.340003Z
"""
...
class BecomingDerivative(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"BECOMING_DERIVATIVE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="BECOMING_DERIVATIVE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"BECOMING_DERIVATIVE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.becoming_derivative import BecomingDerivative\n>>> # TODO: fill example"
