"""
Auto-generated from dictionary entry: TRACKER_ATTRACTOR_TAIL
...
Auto-generated at 2025-10-19T01:26:51.517039Z
"""
...
class TrackerAttractorTail(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TRACKER_ATTRACTOR_TAIL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TRACKER_ATTRACTOR_TAIL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TRACKER_ATTRACTOR_TAIL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TRACKER_ATTRACTOR_TAIL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.tracker_attractor_tail import TrackerAttractorTail\n>>> # TODO: fill example"
