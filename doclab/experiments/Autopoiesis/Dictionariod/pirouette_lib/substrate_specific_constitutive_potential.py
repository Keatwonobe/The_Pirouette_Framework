"""
Auto-generated from dictionary entry: SUBSTRATE_SPECIFIC_CONSTITUTIVE_POTENTIAL
...
Auto-generated at 2025-10-19T01:26:51.400040Z
"""
...
class SubstrateSpecificConstitutivePotential(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="SUBSTRATE_SPECIFIC_CONSTITUTIVE_POTENTIAL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SUBSTRATE_SPECIFIC_CONSTITUTIVE_POTENTIAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SUBSTRATE_SPECIFIC_CONSTITUTIVE_POTENTIAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SUBSTRATE_SPECIFIC_CONSTITUTIVE_POTENTIAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.substrate_specific_constitutive_potential import SubstrateSpecificConstitutivePotential\n>>> # TODO: fill example"
