"""
Auto-generated from dictionary entry: CATASTROPHIC_STABILITY
...
Auto-generated at 2025-10-19T01:26:50.370003Z
"""
...
class CatastrophicStability(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CATASTROPHIC_STABILITY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CATASTROPHIC_STABILITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CATASTROPHIC_STABILITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CATASTROPHIC_STABILITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.catastrophic_stability import CatastrophicStability\n>>> # TODO: fill example"
