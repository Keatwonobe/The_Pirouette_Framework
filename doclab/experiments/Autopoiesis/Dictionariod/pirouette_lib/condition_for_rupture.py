"""
Auto-generated from dictionary entry: CONDITION_FOR_RUPTURE
...
Auto-generated at 2025-10-19T01:26:50.546484Z
"""
...
class ConditionForRupture(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CONDITION_FOR_RUPTURE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CONDITION_FOR_RUPTURE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CONDITION_FOR_RUPTURE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CONDITION_FOR_RUPTURE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.condition_for_rupture import ConditionForRupture\n>>> # TODO: fill example"
