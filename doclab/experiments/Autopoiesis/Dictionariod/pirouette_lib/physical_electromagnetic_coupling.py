"""
Auto-generated from dictionary entry: PHYSICAL_ELECTROMAGNETIC_COUPLING
...
Auto-generated at 2025-10-19T01:26:51.106307Z
"""
...
class PhysicalElectromagneticCoupling(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PHYSICAL_ELECTROMAGNETIC_COUPLING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PHYSICAL_ELECTROMAGNETIC_COUPLING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PHYSICAL_ELECTROMAGNETIC_COUPLING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PHYSICAL_ELECTROMAGNETIC_COUPLING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.physical_electromagnetic_coupling import PhysicalElectromagneticCoupling\n>>> # TODO: fill example"
