"""
Auto-generated from dictionary entry: KI_EXPECTATION_VALUE
Term: KI_EXPECTATION_VALUE
Symbol: 
Aliases: 
...
Auto-generated at 2025-10-19T01:26:50.918307Z
"""
...
class KiExpectationValue(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="KI_EXPECTATION_VALUE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"KI_EXPECTATION_VALUE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="KI_EXPECTATION_VALUE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"KI_EXPECTATION_VALUE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.ki_expectation_value import KiExpectationValue\n>>> # TODO: fill example"
