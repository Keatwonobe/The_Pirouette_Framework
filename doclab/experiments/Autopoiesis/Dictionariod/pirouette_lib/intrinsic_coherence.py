"""
Auto-generated from dictionary entry: INTRINSIC_COHERENCE
...
Auto-generated at 2025-10-19T01:26:50.892681Z
"""
...
class IntrinsicCoherence(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"INTRINSIC_COHERENCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="INTRINSIC_COHERENCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"INTRINSIC_COHERENCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.intrinsic_coherence import IntrinsicCoherence\n>>> # TODO: fill example"
