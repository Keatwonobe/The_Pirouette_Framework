"""
Auto-generated from dictionary entry: DOMINANT_FLOW_STATE
...
Auto-generated at 2025-10-19T01:26:50.652680Z
"""
...
class DominantFlowState(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DOMINANT_FLOW_STATE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DOMINANT_FLOW_STATE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DOMINANT_FLOW_STATE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.dominant_flow_state import DominantFlowState\n>>> # TODO: fill example"
