"""
Auto-generated from dictionary entry: ENVIRONMENTAL_NOISE
...
Auto-generated at 2025-10-19T01:26:50.699680Z
"""
...
class EnvironmentalNoise(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ENVIRONMENTAL_NOISE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ENVIRONMENTAL_NOISE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ENVIRONMENTAL_NOISE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.environmental_noise import EnvironmentalNoise\n>>> # TODO: fill example"
