"""
Auto-generated from dictionary entry: RESONANT_SPECTRUM_ANALYSIS
...
Auto-generated at 2025-10-19T01:26:51.267462Z
"""
...
class ResonantSpectrumAnalysis(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RESONANT_SPECTRUM_ANALYSIS:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RESONANT_SPECTRUM_ANALYSIS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RESONANT_SPECTRUM_ANALYSIS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RESONANT_SPECTRUM_ANALYSIS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.resonant_spectrum_analysis import ResonantSpectrumAnalysis\n>>> # TODO: fill example"
