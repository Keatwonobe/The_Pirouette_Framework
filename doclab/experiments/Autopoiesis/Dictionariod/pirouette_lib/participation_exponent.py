"""
Auto-generated from dictionary entry: PARTICIPATION_EXPONENT
...
Auto-generated at 2025-10-19T01:26:51.074307Z
"""
...
class ParticipationExponent(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PARTICIPATION_EXPONENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PARTICIPATION_EXPONENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PARTICIPATION_EXPONENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PARTICIPATION_EXPONENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.participation_exponent import ParticipationExponent\n>>> # TODO: fill example"
