"""
Auto-generated from dictionary entry: CHALLENGE_HARMONICS
...
Auto-generated at 2025-10-19T01:26:50.377003Z
"""
...
class ChallengeHarmonics(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CHALLENGE_HARMONICS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CHALLENGE_HARMONICS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CHALLENGE_HARMONICS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.challenge_harmonics import ChallengeHarmonics\n>>> # TODO: fill example"
