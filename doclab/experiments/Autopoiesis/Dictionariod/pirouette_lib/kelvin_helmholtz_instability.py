"""
Auto-generated from dictionary entry: KELVIN_HELMHOLTZ_INSTABILITY
...
Auto-generated at 2025-10-19T01:26:50.911308Z
"""
...
class KelvinHelmholtzInstability(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="KELVIN_HELMHOLTZ_INSTABILITY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"KELVIN_HELMHOLTZ_INSTABILITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="KELVIN_HELMHOLTZ_INSTABILITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"KELVIN_HELMHOLTZ_INSTABILITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.kelvin_helmholtz_instability import KelvinHelmholtzInstability\n>>> # TODO: fill example"
