"""
Auto-generated from dictionary entry: PARTICIPATION_RATIO
...
Auto-generated at 2025-10-19T01:26:51.075307Z
"""
...
class ParticipationRatio(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PARTICIPATION_RATIO:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PARTICIPATION_RATIO:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PARTICIPATION_RATIO:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.participation_ratio import ParticipationRatio\n>>> # TODO: fill example"
