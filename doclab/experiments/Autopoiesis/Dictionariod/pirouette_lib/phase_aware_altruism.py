"""
Auto-generated from dictionary entry: PHASE_AWARE_ALTRUISM
...
Auto-generated at 2025-10-19T01:26:51.088307Z
"""
...
class PhaseAwareAltruism(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PHASE_AWARE_ALTRUISM:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PHASE_AWARE_ALTRUISM:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PHASE_AWARE_ALTRUISM:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PHASE_AWARE_ALTRUISM:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.phase_aware_altruism import PhaseAwareAltruism\n>>> # TODO: fill example"
