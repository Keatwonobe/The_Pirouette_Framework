"""
Auto-generated from dictionary entry: LEPTONIC_MAGNETIC_MOMENT_SHIFT
...
Auto-generated at 2025-10-19T01:26:50.971307Z
"""
...
class LeptonicMagneticMomentShift(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="LEPTONIC_MAGNETIC_MOMENT_SHIFT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"LEPTONIC_MAGNETIC_MOMENT_SHIFT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="LEPTONIC_MAGNETIC_MOMENT_SHIFT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"LEPTONIC_MAGNETIC_MOMENT_SHIFT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.leptonic_magnetic_moment_shift import LeptonicMagneticMomentShift\n>>> # TODO: fill example"
