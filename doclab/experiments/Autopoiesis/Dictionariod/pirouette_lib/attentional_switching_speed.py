"""
Auto-generated from dictionary entry: ATTENTIONAL_SWITCHING_SPEED
...
Auto-generated at 2025-10-19T01:26:50.307003Z
"""
...
class AttentionalSwitchingSpeed(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ATTENTIONAL_SWITCHING_SPEED:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ATTENTIONAL_SWITCHING_SPEED:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ATTENTIONAL_SWITCHING_SPEED:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ATTENTIONAL_SWITCHING_SPEED:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.attentional_switching_speed import AttentionalSwitchingSpeed\n>>> # TODO: fill example"
