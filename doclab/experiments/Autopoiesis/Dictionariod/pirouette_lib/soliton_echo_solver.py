"""
Auto-generated from dictionary entry: SOLITON_ECHO_SOLVER
...
Auto-generated at 2025-10-19T01:26:51.351050Z
"""
...
class SolitonEchoSolver(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"SOLITON_ECHO_SOLVER:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="SOLITON_ECHO_SOLVER:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"SOLITON_ECHO_SOLVER:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.soliton_echo_solver import SolitonEchoSolver\n>>> # TODO: fill example"
