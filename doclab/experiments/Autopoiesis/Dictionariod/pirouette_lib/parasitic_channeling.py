"""
Auto-generated from dictionary entry: PARASITIC_CHANNELING
...
Auto-generated at 2025-10-19T01:26:51.071307Z
"""
...
class ParasiticChanneling(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="PARASITIC_CHANNELING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"PARASITIC_CHANNELING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="PARASITIC_CHANNELING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"PARASITIC_CHANNELING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.parasitic_channeling import ParasiticChanneling\n>>> # TODO: fill example"
