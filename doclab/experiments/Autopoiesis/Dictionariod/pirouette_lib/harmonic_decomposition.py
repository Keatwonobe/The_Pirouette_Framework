"""
Auto-generated from dictionary entry: HARMONIC_DECOMPOSITION
...
Auto-generated at 2025-10-19T01:26:50.828680Z
"""
...
class HarmonicDecomposition(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="HARMONIC_DECOMPOSITION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"HARMONIC_DECOMPOSITION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="HARMONIC_DECOMPOSITION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"HARMONIC_DECOMPOSITION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.harmonic_decomposition import HarmonicDecomposition\n>>> # TODO: fill example"
