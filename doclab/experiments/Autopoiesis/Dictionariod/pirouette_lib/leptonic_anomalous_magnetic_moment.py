"""
Auto-generated from dictionary entry: LEPTONIC_ANOMALOUS_MAGNETIC_MOMENT
...
Auto-generated at 2025-10-19T01:26:50.968306Z
"""
...
class LeptonicAnomalousMagneticMoment(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="LEPTONIC_ANOMALOUS_MAGNETIC_MOMENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"LEPTONIC_ANOMALOUS_MAGNETIC_MOMENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="LEPTONIC_ANOMALOUS_MAGNETIC_MOMENT:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"LEPTONIC_ANOMALOUS_MAGNETIC_MOMENT:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.leptonic_anomalous_magnetic_moment import LeptonicAnomalousMagneticMoment\n>>> # TODO: fill example"
