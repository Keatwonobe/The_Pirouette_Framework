"""
Auto-generated from dictionary entry: X_RAY_SURFACE_BRIGHTNESS
...
Auto-generated at 2025-10-19T01:26:51.609039Z
"""
...
class XRaySurfaceBrightness(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="X_RAY_SURFACE_BRIGHTNESS:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"X_RAY_SURFACE_BRIGHTNESS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="X_RAY_SURFACE_BRIGHTNESS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"X_RAY_SURFACE_BRIGHTNESS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.x_ray_surface_brightness import XRaySurfaceBrightness\n>>> # TODO: fill example"
