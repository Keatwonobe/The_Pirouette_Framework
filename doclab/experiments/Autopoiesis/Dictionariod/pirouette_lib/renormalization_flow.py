"""
Auto-generated from dictionary entry: RENORMALIZATION_FLOW
...
Auto-generated at 2025-10-19T01:26:51.204461Z
"""
...
class RenormalizationFlow(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="RENORMALIZATION_FLOW:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RENORMALIZATION_FLOW:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RENORMALIZATION_FLOW:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RENORMALIZATION_FLOW:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.renormalization_flow import RenormalizationFlow\n>>> # TODO: fill example"
