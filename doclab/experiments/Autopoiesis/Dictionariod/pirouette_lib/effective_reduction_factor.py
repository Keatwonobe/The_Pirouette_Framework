"""
Auto-generated from dictionary entry: EFFECTIVE_REDUCTION_FACTOR
...
Auto-generated at 2025-10-19T01:26:50.674680Z
"""
...
class EffectiveReductionFactor(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="EFFECTIVE_REDUCTION_FACTOR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"EFFECTIVE_REDUCTION_FACTOR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="EFFECTIVE_REDUCTION_FACTOR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"EFFECTIVE_REDUCTION_FACTOR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.effective_reduction_factor import EffectiveReductionFactor\n>>> # TODO: fill example"
