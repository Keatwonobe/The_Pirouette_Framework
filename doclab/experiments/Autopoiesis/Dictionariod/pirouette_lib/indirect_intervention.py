"""
Auto-generated from dictionary entry: INDIRECT_INTERVENTION
...
Auto-generated at 2025-10-19T01:26:50.858680Z
"""
...
class IndirectIntervention(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="INDIRECT_INTERVENTION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"INDIRECT_INTERVENTION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="INDIRECT_INTERVENTION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"INDIRECT_INTERVENTION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.indirect_intervention import IndirectIntervention\n>>> # TODO: fill example"
