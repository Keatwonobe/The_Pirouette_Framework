"""
Auto-generated from dictionary entry: ENERGY_DEPENDENT_MASS
...
Auto-generated at 2025-10-19T01:26:50.687680Z
"""
...
class EnergyDependentMass(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ENERGY_DEPENDENT_MASS:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ENERGY_DEPENDENT_MASS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ENERGY_DEPENDENT_MASS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ENERGY_DEPENDENT_MASS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.energy_dependent_mass import EnergyDependentMass\n>>> # TODO: fill example"
