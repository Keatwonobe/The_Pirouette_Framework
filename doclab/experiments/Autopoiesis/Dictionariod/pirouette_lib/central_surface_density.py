"""
Auto-generated from dictionary entry: CENTRAL_SURFACE_DENSITY
...
Auto-generated at 2025-10-19T01:26:50.374003Z
"""
...
class CentralSurfaceDensity(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CENTRAL_SURFACE_DENSITY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CENTRAL_SURFACE_DENSITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CENTRAL_SURFACE_DENSITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CENTRAL_SURFACE_DENSITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.central_surface_density import CentralSurfaceDensity\n>>> # TODO: fill example"
