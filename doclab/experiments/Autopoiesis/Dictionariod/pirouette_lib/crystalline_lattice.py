"""
Auto-generated from dictionary entry: CRYSTALLINE_LATTICE
...
Auto-generated at 2025-10-19T01:26:50.608681Z
"""
...
class CrystallineLattice(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CRYSTALLINE_LATTICE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CRYSTALLINE_LATTICE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CRYSTALLINE_LATTICE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.crystalline_lattice import CrystallineLattice\n>>> # TODO: fill example"
