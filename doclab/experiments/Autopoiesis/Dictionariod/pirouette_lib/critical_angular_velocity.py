"""
Auto-generated from dictionary entry: CRITICAL_ANGULAR_VELOCITY
...
Auto-generated at 2025-10-19T01:26:50.587681Z
"""
...
class CriticalAngularVelocity(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CRITICAL_ANGULAR_VELOCITY:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CRITICAL_ANGULAR_VELOCITY:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="CRITICAL_ANGULAR_VELOCITY:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"CRITICAL_ANGULAR_VELOCITY:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.critical_angular_velocity import CriticalAngularVelocity\n>>> # TODO: fill example"
