"""
Auto-generated from dictionary entry: MASS_DEPENDENT_COUPLING
...
Auto-generated at 2025-10-19T01:26:51.002308Z
"""
...
class MassDependentCoupling(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="MASS_DEPENDENT_COUPLING:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MASS_DEPENDENT_COUPLING:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MASS_DEPENDENT_COUPLING:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MASS_DEPENDENT_COUPLING:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.mass_dependent_coupling import MassDependentCoupling\n>>> # TODO: fill example"
