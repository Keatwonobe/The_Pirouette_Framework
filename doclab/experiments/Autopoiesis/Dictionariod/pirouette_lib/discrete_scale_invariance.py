"""
Auto-generated from dictionary entry: DISCRETE_SCALE_INVARIANCE
...
Auto-generated at 2025-10-19T01:26:50.639680Z
"""
...
class DiscreteScaleInvariance(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="DISCRETE_SCALE_INVARIANCE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"DISCRETE_SCALE_INVARIANCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="DISCRETE_SCALE_INVARIANCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"DISCRETE_SCALE_INVARIANCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.discrete_scale_invariance import DiscreteScaleInvariance\n>>> # TODO: fill example"
