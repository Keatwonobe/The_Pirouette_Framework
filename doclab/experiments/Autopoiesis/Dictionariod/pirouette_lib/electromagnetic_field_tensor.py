"""
Auto-generated from dictionary entry: ELECTROMAGNETIC_FIELD_TENSOR
...
Auto-generated at 2025-10-19T01:26:50.681680Z
"""
...
class ElectromagneticFieldTensor(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ELECTROMAGNETIC_FIELD_TENSOR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ELECTROMAGNETIC_FIELD_TENSOR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ELECTROMAGNETIC_FIELD_TENSOR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ELECTROMAGNETIC_FIELD_TENSOR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.electromagnetic_field_tensor import ElectromagneticFieldTensor\n>>> # TODO: fill example"
