"""
Auto-generated from dictionary entry: EXTERNALITY_FOOTPRINT_TAG
...
Auto-generated at 2025-10-19T01:26:50.709680Z
"""
...
class ExternalityFootprintTag(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="EXTERNALITY_FOOTPRINT_TAG:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"EXTERNALITY_FOOTPRINT_TAG:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="EXTERNALITY_FOOTPRINT_TAG:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"EXTERNALITY_FOOTPRINT_TAG:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.externality_footprint_tag import ExternalityFootprintTag\n>>> # TODO: fill example"
