"""
Auto-generated from dictionary entry: TRANSACTIONAL_IMPERATIVE
...
Auto-generated at 2025-10-19T01:26:51.518039Z
"""
...
class TransactionalImperative(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="TRANSACTIONAL_IMPERATIVE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"TRANSACTIONAL_IMPERATIVE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="TRANSACTIONAL_IMPERATIVE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"TRANSACTIONAL_IMPERATIVE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.transactional_imperative import TransactionalImperative\n>>> # TODO: fill example"
