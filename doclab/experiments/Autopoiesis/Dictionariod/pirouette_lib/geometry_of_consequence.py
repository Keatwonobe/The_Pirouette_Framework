"""
Auto-generated from dictionary entry: GEOMETRY_OF_CONSEQUENCE
...
Auto-generated at 2025-10-19T01:26:50.799729Z
"""
...
class GeometryOfConsequence(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="GEOMETRY_OF_CONSEQUENCE:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"GEOMETRY_OF_CONSEQUENCE:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="GEOMETRY_OF_CONSEQUENCE:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"GEOMETRY_OF_CONSEQUENCE:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.geometry_of_consequence import GeometryOfConsequence\n>>> # TODO: fill example"
