"""
Auto-generated from dictionary entry: CONSTRAINT_SHATTERING_EVENT
...
Auto-generated at 2025-10-19T01:26:50.560483Z
"""
...
class ConstraintShatteringEvent(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="CONSTRAINT_SHATTERING_EVENT:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"CONSTRAINT_SHATTERING_EVENT:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.constraint_shattering_event import ConstraintShatteringEvent\n>>> # TODO: fill example"
