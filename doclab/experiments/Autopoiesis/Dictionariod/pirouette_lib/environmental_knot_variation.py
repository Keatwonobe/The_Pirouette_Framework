"""
Auto-generated from dictionary entry: ENVIRONMENTAL_KNOT_VARIATION
...
Auto-generated at 2025-10-19T01:26:50.698680Z
"""
...
class EnvironmentalKnotVariation(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ENVIRONMENTAL_KNOT_VARIATION:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ENVIRONMENTAL_KNOT_VARIATION:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ENVIRONMENTAL_KNOT_VARIATION:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ENVIRONMENTAL_KNOT_VARIATION:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.environmental_knot_variation import EnvironmentalKnotVariation\n>>> # TODO: fill example"
