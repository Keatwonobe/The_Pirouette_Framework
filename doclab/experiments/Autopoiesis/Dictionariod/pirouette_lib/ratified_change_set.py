"""
Auto-generated from dictionary entry: RATIFIED_CHANGE_SET
...
Auto-generated at 2025-10-19T01:26:51.191306Z
"""
...
class RatifiedChangeSet(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"RATIFIED_CHANGE_SET:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="RATIFIED_CHANGE_SET:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"RATIFIED_CHANGE_SET:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.ratified_change_set import RatifiedChangeSet\n>>> # TODO: fill example"
