"""
Auto-generated from dictionary entry: COARSE_GRAINED_STRESS_ENERGY_TENSOR
...
Auto-generated at 2025-10-19T01:26:50.401003Z
"""
...
class CoarseGrainedStressEnergyTensor(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="COARSE_GRAINED_STRESS_ENERGY_TENSOR:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"COARSE_GRAINED_STRESS_ENERGY_TENSOR:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="COARSE_GRAINED_STRESS_ENERGY_TENSOR:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"COARSE_GRAINED_STRESS_ENERGY_TENSOR:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.coarse_grained_stress_energy_tensor import CoarseGrainedStressEnergyTensor\n>>> # TODO: fill example"
