"""
Auto-generated from dictionary entry: ENVIRONMENTAL_POTENTIAL
...
Auto-generated at 2025-10-19T01:26:50.700680Z
"""
...
class EnvironmentalPotential(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        tasks.append(Measurement(
            name="ENVIRONMENTAL_POTENTIAL:noop",
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"ENVIRONMENTAL_POTENTIAL:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="ENVIRONMENTAL_POTENTIAL:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"ENVIRONMENTAL_POTENTIAL:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.environmental_potential import EnvironmentalPotential\n>>> # TODO: fill example"
