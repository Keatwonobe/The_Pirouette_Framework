"""
Auto-generated from dictionary entry: MAPPING_THE_SHADOWS
...
Auto-generated at 2025-10-19T01:26:50.999307Z
"""
...
class MappingTheShadows(Term):
    ...
    def measure(self, ctx: Context) -> List[Measurement]:
        ...
        for i, desc in enumerate(MEASURE_BULLETS, 1):
            tasks.append(Measurement(
                name=f"MAPPING_THE_SHADOWS:m{i}",
                description=desc,
                compute=lambda c: c.get("data")
            ))
        return tasks
    ...
    def constraints(self) -> List[Constraint]:
        ...
        checks.append(Constraint(
            name="MAPPING_THE_SHADOWS:exists",
        ...
        for i, desc in enumerate(CONSTRAINT_BULLETS, 1):
            checks.append(Constraint(
                name=f"MAPPING_THE_SHADOWS:c{i}",
                description=desc,
                check=_always_true
            ))
        return checks
    ...
    def example(self) -> str:
        ...
        """
        return ">>> from pirouette_lib.mapping_the_shadows import MappingTheShadows\n>>> # TODO: fill example"
