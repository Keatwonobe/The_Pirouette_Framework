...
def main():
    ...
    p.add_argument("modules_dir", default="C:/Users/keatw/OneDrive/Documents/Doclab/Big_Datasets/target/paper/Pirouette_Volume_6/doclab/experiments/Autopoiesis/Essentialization/to_do", help="Path to directory with *.md modules")
