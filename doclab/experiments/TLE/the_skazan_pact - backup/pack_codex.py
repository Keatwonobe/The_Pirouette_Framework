...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", required=True, help="Root directory containing JSON folders")
    parser.add_argument("--output", default="tle_codex_bundle.json", help="Output bundle path")
