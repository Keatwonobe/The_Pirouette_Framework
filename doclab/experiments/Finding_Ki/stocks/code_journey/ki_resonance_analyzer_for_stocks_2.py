...
def generate_raw_data(data_directory, raw_csv_file, chk_file, batch_size=1000):
    ...
    # --- ADDED: Explicitly sort the list to ensure a consistent order for checkpointing ---
    all_files.sort()
    ...
    with tqdm(total=len(all_files), initial=resume_idx, desc="Step 1: Generating Raw Data") as pbar:
        for i, filepath in enumerate(files_to_process):
            ...
            try:
                ...
                price_trend_signal = df['Close'].diff().abs().dropna().to_numpy()
    ...
    print(f"Skipped (insufficient price movement, <50 days): {files_skipped_no_movement} files.")
...
if __name__ == '__main__':
    # --- Configuration ---
    DATASET_DIRECTORY = "C:/Users/keatw/OneDrive/Documents/Doclab/Big_Datasets/stocks_rightsized"
