"""
DDE-Pirouette Folder Synchronizer v3.0
...
def sync_folder_to_dde(folder_path_str: str, master_vocab_path: str = None):
    """
    ...
    for md_path in md_files:
        try:
            ...
            # This calls _build_vocab, which will now
            # ADD to the primed vocab instead of starting from scratch
    ...
    # --------------------------------------------------------------------
    print("\n" + "─" * 70)
    print("STAGE 4: SAVING DATABASE MANIFEST (WITH FULL VOCAB)")
    print("─" * 70)
    
    output_filename = f"dde_db_{db_label}.json"
    
    # This will now save the FULL vocabulary
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="DDE Folder Synchronizer v3.0 (Vocab Priming)"
    )
    parser.add_argument(
        "folder_path", 
        type=str, 
    ...
    sync_folder_to_dde(args.folder_path, args.vocab_file)