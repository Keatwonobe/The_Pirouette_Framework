...
CENTER_M = 1333689.982       # The "Puncture" (Origin)
CENTER_L = 770007.6
ZOOM_WIDTH = 1    # Zoom level (smaller = closer)

TWIST = 3.8          # Tension
DT = 0.01            # Smaller time step for precision
STEPS = 1500          # Longer tracking to see the full "braid" develop
...
def run_analysis():
    ...
    ax.scatter([CENTER_M], [CENTER_L], color='cyan', marker='+', s=100, alpha=0.5, label='Center')
