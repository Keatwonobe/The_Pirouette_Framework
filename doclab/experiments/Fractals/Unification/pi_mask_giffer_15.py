...
# =========================================================
#  PIRouette Vectorized Giffer (Wider View, Low T-Steps)
# =========================================================
...
GAMMA = 0.5
DT    = 0.015
MAX_STEPS = 5      # <--- FOCUS ON INITIAL EXPANSION (T=1 to T=5)
EPSILON = 1e-5
R_ESCAPE = 100.0   

# ---------- Viewport (Zoomed out to +/- 1000) ----------
M_MIN, M_MAX = -1000.0, 1000.0    # Zoomed out coordinates
L_MIN, L_MAX = -1000.0, 1000.0
RES = 800          # Higher resolution for wider view
FRAME_SKIP = 1     
FPS = 5            # Frame rate for the final GIF

# ---------- Output Settings ----------
OUTPUT_DIR = "fractal_frames_wide_lowT"
GIF_NAME = "initial_spread_t1_t5.gif"
...
def run_evolution():
    ...
    frames = []
    print(f"Starting time evolution from T=1 to T={MAX_STEPS} on a {M_MAX} extent...")
    ...
    for step in range(1, MAX_STEPS + 1):
        ...
        if step % FRAME_SKIP == 0:
            ...
            # Adding a title to track the view and T-step
            ax.set_title(f"Evolution Step (T): {step}\nView Extent: +/- {M_MAX:.0f}")
