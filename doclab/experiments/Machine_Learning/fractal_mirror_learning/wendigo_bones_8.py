#!/usr/bin/env python3
"""
wendigo_bones_ratchet.py

Implements a RatchetPolicyArchive. The threshold for archiving a new policy
can only ever increase, ensuring that only progressively better "milestone"
policies are saved. This prevents the archive from being polluted by mediocre
runs during performance slumps.
"""
...
def train():
    ...
    for ep in range(1, total_eps + 1):
        ...
        # Use the new ratcheting logic for storing
