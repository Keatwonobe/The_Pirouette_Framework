...
class Config:
    ...
    tpci_threshold: float = 0.4  # Below this, we enter "Stabilization Mode"
...
def main():
    ...
    print(f"--- SAND ENGRAM 02: THE HELICAL OPERATOR ---")
    print(f"Env: {config.env_id}")
    print(f"TPCI Threshold: {config.tpci_threshold}")
