...
class CheckpointManager:
    ...
    def save_checkpoint(self, episode: int, policy_state: dict, 
                       optimizer_state: dict, metrics: dict):
        """Save checkpoint atomically."""
        # Save policy and optimizer
        checkpoint = {
            'episode': episode,
...
# ============================================================================
# REINFORCE Trainer (Simple but Effective)
# ============================================================================
...
class REINFORCETrainer:
    ...
    Chosen for:
    - Simplicity (no value network needed)
    - Stability
    - Works well with incremental pattern
    """
    ...
    def train_episode(self, env, metrics_tracker: Optional[SandMetrics] = None):
        """
        Run single episode and update policy.
        ...
        for step in range(self.config.max_steps):
            ...
            # Sample action
            # to get a "live" log_prob for the loss function.
            action, log_prob = self.policy.sample_action(obs_t)
            
            # Detach the action for the environment step
...
class IncrementalRLTrainer:
    ...
    def __init__(self, config: Config, output_dir: Path):
        ...
        # Trainer
        self.trainer = REINFORCETrainer(self.policy, config, self.device)
