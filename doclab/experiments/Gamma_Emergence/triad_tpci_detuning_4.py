# File: 2_process_task.py
# This file is identical to your original script, but with a modified `main` function.
# All helper functions (read_raw_any, tpci, halfwidth_gauss, etc.) are the same.
# --- [All helper functions from your original script go here] ---
...
# (Paste all your helper and process_file functions here without any changes)
...
def main():
    ...
    # --- New arguments for modular processing ---
    ...
    try:
        ...
        # We re-raise the exception to ensure the calling script knows it failed
